...
Licensing is undecided. See `docs/game-design-and-architecture.md` in `project-soccer/game` (locally `../game/docs/game-design-and-architecture.md`). All documentation must be written in English.
